...
// @ts-ignore necessary
/** @template {Validator<any, any, any>} V @typedef {ReturnType<V> extends E.Left<ReadonlyArray<infer E>> | E.Right<any> ? CustomValidationErrorAlgebra<E & { __tag: 'condition' }> : never} ValidatorCustomErrors */
